...
COPY adventure_works.dim_account FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimAccount.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_currency FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimCurrency.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_customer FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimCustomer.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_date FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimDate.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_department_group FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimDepartmentGroup.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_employee FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimEmployee.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_geography FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimGeography.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_organization FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimOrganization.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_product FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimProduct.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_product_category FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimProductCategory.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_product_subcategory FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimProductSubcategory.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_promotion FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimPromotion.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_reseller FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimReseller.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_sales_reason FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimSalesReason.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_sales_territory FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimSalesTerritory.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.dim_scenario FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/DimScenario.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_additional_international_product_description FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactAdditionalInternationalProductDescription.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_call_center FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactCallCenter.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_currency_rate FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactCurrencyRate.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_finance FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactFinance.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_internet_sales FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactInternetSales.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_internet_sales_reason FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactInternetSalesReason.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_product_inventory FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactProductInventory.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_reseller_sales FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactResellerSales.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_sales_quota FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactSalesQuota.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.fact_survey_response FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/FactSurveyResponse.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.new_fact_currency_rate FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/NewFactCurrencyRate.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
COPY adventure_works.prospective_buyer FROM 'C:/python/ucm-tfm-grupo-4/data/database/postgres/db_creation/ProspectiveBuyer.csv' WITH (DELIMITER '|', FORMAT CSV, HEADER FALSE, ENCODING 'UTF8');
